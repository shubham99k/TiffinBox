...
function CookOrders() {
  ...
  const [confirmStatusUpdate, setConfirmStatusUpdate] = useState(null) // { id, status }
          ...
          {["orders", "reviews"].map((tab) => (
            <button
              ...
              style={{
                ...
                border:
                  activeTab === tab
                    ? "1.5 px solid var(--brand)"
                    : "1.5px solid var(--border)",
                background:
                  activeTab === tab ? "var(--brand-light)" : "var(--white)",
            ...
            >
              {tab === "orders"
                ? <span style={{ display: 'flex', alignItems: 'center', gap: '6px' }}><Package size={16} /> Orders ({orders.length})</span>
                : <span style={{ display: 'flex', alignItems: 'center', gap: '6px' }}><Star size={16} fill="currentColor" /> Reviews ({reviews.length})</span>}
            </button>
          ))}
        </div>
                  ...
                  <div style={{ padding: "20px 24px" }}>
                    ...
                    >
                      <div>
                        ...
                        <div
                          style={{ fontSize: "13px", color: "var(--subtle)" }}
                        >
