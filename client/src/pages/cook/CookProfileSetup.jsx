...
function CookProfileSetup() {
  ...
  const [formData, setFormData] = useState({
    bio: '', cuisineType: '', city: user?.city || '', address: ''
  })
  ...
  return (
    <div className='setup-wrap'>
      <div className='setup-card'>
        ...
        <div className='setup-title'>Setup your profile</div>
        <div className='setup-sub'>Tell customers about yourself and your cooking</div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ marginBottom: '16px' }}>
            <div className='inp-label' style={{ marginBottom: '8px' }}>Profile Photo</div>
          ...
          <div className='inp-wrap'>
            ...
            <input
              className='inp-field' type='text'
              name='cuisineType' value={formData.cuisineType}
              onChange={handleChange}
