          ...
          <div
            ...
            <aside style={{ position: "sticky", top: "96px" }}>
              <div style={{ position: "sticky", top: "96px" }}>
                <p className='inp-label' style={{ marginBottom: "16px" }}>
                  Contents
                </p>
              ...
              <section id='liability' style={{ scrollMarginTop: "96px" }}>
                ...
                <div
                  ...
                  <p
                    ...
                    TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, TIFFINBOX
                  ...
                  <p
                    ...
                    shall not exceed the amount paid by you to the Company in
  ...
  return (
    <h2
      ...
      <span
        ...
        <span
          className='material-symbols-outlined'
          style={{ fontSize: "18px", color: "var(--primary-fixed)" }}>
          {icon}
        </span>
      </span>
      <span
