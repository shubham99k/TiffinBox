      ...
      <div
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            <div
              ...
              <div
                ...
                style={{ marginBottom: 0, fontSize: "1.75rem" }}>
                {user.name}
              </div>
        ...
        <div className='stats-grid' style={{ marginBottom: "28px" }}>
          <div className='stat-card'>
            ...
            <div className='stat-card-value'>{orders.stats.totalOrders}</div>
          </div>
          <div className='stat-card'>
              ...
              <tbody>
                {orders.recent.map((o) => (
                  <tr key={o._id}>
                    ...
                    <td>
                      <span className={`badge ${statusClass(o.paymentStatus)}`}>
                        {o.paymentStatus}
                      </span>
                    </td>
                    <td
