...
function Alert({ type = "error", message, onClose, duration = 2500 }) {
  ...
  const styles = {
    error: { bg: "#FEF2F2", color: "#DC2626", border: "#FECACA", bar: "#DC2626" },
    success: { bg: "#F0FDF4", color: "#16A34A", border: "#BBF7D0", bar: "#16A34A" },
    warning: { bg: "#FFFBEB", color: "#D97706", border: "#FDE68A", bar: "#D97706" },
      ...
      <div style={{ padding: "12px 16px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        ...
        {onClose && (
          <span
            ...
            style={{ cursor: "pointer", fontSize: "16px", marginLeft: "12px", opacity: 0.6 }}
          >
            ×
          </span>
        )}
